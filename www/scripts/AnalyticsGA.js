AnalyticsGA = {
    AppName: "NoName",
    Version: "0.0.0.0",
    Property: "UA-43146845-6"

};
// wrap in function call
AnalyticsGA.TrackStart = function (appName, version, property) {

    localStorage.appName = appName;
    localStorage.version = version;

    AnalyticsGA.AppName = appName;
    AnalyticsGA.Version = version;
    AnalyticsGA.Property = property;
...
AnalyticsGA.TrackPage = function (page, urlParameters) {
    ...
    })(window, document, 'script', 'scripts/Analytics_Google.js', 'ga');
